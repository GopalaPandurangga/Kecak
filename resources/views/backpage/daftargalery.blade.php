        ...
        <div class="shadow px-6 py-4 bg-white rounded sm:px-1 sm:py-1">
            <div class="grid grid-cols-12">
                <div class="col-span-6 p-4">
                    <a href="{{route('daftargalery.create')}}"><button
                ...
                <table class="min-w-full divide-y divide-gray-200 p-2">
                    ...
                    <tbody class="bg-white divide-y divide-gray-200">
                        ...
                        <tr>
                            ...
                            <td>{{$data -> desc}}</td>
                            <td>
                                <img src="{{asset('storage/'.$data->photo)}}" class="w-16" alt="">
                            </td>
                            <td>

                                <form action="{{route('daftargalery.destroy', $data->galery_id)}}" method="POST">
                                    @csrf
                                    @method('DELETE')

                                    <a href="{{route('daftargalery.edit', $data->galery_id)}}"
