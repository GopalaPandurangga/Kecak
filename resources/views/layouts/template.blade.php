...
<body>
    <!--header-->
    <header class="absolute bg-gray-100 dark:bg-dark top-0 left-0 w-full flex items-center z-10 ">
        <div class="container  ">
            <div class="flex items-center justify-between relative">
                <div class="">
                    <a href="home" class="font-bold font-pt-serif text-2xl px-10 lg:px-0 text-black dark:text-white block py-4">Kecak</a>
                </div>
                <div class="flex items-center px-10 lg:px-2">
                    <div id="hamburger" name="hamburger" type="button" class="block lg:hidden absolute right-10">
                        ...
                        <span class="hamburger-line transition duration-300
                        ease-in-out"></span>
                        <span class="hamburger-line  origin-bottom-left transition duration-300
                        ease-in-out"></span>
                    </div>
                    <nav id="nav-menu"
                        class="hidden absolute py-5  bg-white
                    shadow-lg rounded-lg lg:shadow-none lg:rounded-none max-w-[250px] lg:w-full right-4 top-full lg:block lg:static lg:bg-transparent dark:bg-dark dark:shadow-slate-500 lg:dark:bg-transparent lg:max-w-full">
                        <ul class="block lg:flex ">
                            ...
                            <x-dropdown align="right" width="40">
                                    ...
                                    <x-slot name="content">
                                        ...
                                        <x-dropdown-link :href="route('galery')">
                                            {{ __('Our Galery') }}
                                        </x-dropdown-link>
